...
declare const _default: {
    ...
    'Windows2019 image': {
        WIN_SERVER_CORE_2016_BASE: {
            'has type WINDOWS_SERVER_2019_CONTAINER and default ComputeType MEDIUM'(test: Test): void;
        };
    };
    'ARM image': {
        AMAZON_LINUX_2_ARM: {
    ...
    'webhook Filters': {
        ...
        'can have FILE_PATH filters if the Group contains PUSH and PR_CREATED events'(test: Test): void;
