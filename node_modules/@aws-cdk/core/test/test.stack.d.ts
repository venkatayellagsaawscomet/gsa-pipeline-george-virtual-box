...
declare const _default: {
    ...
    'Cross-stack reference export names are relative to the stack (when the flag is set)'(test: Test): void;
    ...
    'Termination Protection is reflected in Cloud Assembly artifact'(test: Test): void;
    'users can (still) override "synthesize()" in stack'(test: Test): void;
};
export = _default;
